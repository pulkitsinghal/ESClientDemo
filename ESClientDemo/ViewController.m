...
@synthesize testRangeQueryButton;
...
- (void)viewDidUnload
{
    ...
    [self setTestRangeQueryButton:nil];
    [super viewDidUnload];
...
- (IBAction) testRangeQuery : (id) sender
{
    ...
    // hack - https://github.com/RestKit/RestKit/issues/684#issuecomment-5245656
    RKObjectMapping* esRangeQueryMapping = [ESRangeQuery getObjectMapping];
    esRangeQueryMapping.rootKeyPath = @"salePrice";
    [
     [RKObjectManager sharedManager].mappingProvider
     setSerializationMapping:[esRangeQueryMapping inverseMapping]
     forClass:[ESRangeQuery class]
    ];
